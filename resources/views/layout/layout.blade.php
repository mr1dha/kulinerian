...
<head>
	...
	<meta name="description" content="@yield('desc','Situs resep dan infomasi kuliner Indonesia')">
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				...
				<form action="{{url('/pencarian')}}" method="post" class="form-inline my-2 my-lg-0">
					@csrf
					<input class="form-control mr-sm-2" type="text" placeholder="pencarian" aria-label="Search" name="keyword" required>
